...
For the full guide — including Sentinel HA, Cluster, monitoring, performance tuning, and troubleshooting — see the dedicated [Redis](/self-hosting/redis) page.
...
- [Redis](/self-hosting/redis) — full Redis guide: architecture, HA, monitoring, troubleshooting
