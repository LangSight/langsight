...
<Frame>
  <img src="/images/dashbaord_1_page.png" alt="LangSight dashboard — sessions, error rate, latency overview" />
</Frame>
...
<Frame>
  <img src="/images/session_graph_lineage.png" alt="LangSight session graph — multi-agent call tree showing coordinator, sub-agents, and MCP servers" />
</Frame>
