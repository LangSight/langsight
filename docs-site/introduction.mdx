...
- **Session replay** — re-execute a failed session against live servers to reproduce
...
LangSight is BSL 1.1 licensed — self-host free, no usage limits. Converts to Apache 2.0 after 4 years.
