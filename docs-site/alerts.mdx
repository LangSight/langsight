...
<Frame>
  <img src="/images/Alerts_page.png" alt="LangSight alerts page — 8 alert rule types with independent toggles and Slack delivery" />
</Frame>
...
<Frame>
  <img src="/images/slack_alerts.png" alt="Real LangSight Slack alert — agent session failed: tool failure, CRITICAL severity, with View in Dashboard button" />
</Frame>
