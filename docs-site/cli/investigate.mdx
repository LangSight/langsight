...
description: "AI-powered root cause analysis for MCP server failures"
---
...
Falls back to rule-based analysis when no provider is configured. See [AI Providers](/providers/overview) for setup.
