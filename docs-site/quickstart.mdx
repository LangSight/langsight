...
client = LangSightClient(
    ...
    project_id="my-project",   # groups all spans under this project
)
...
<Note>
  On first run, LangSight creates a "Default" project automatically. You can use `project_id="default"` or omit it to send spans to the default project. Create additional projects in the dashboard under Settings.
</Note>
