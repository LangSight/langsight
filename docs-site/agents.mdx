...
Clicking the agent row opens the detail panel. The **Overview** tab in the detail panel shows the individual SLO values — which specific target is breached and by how much.

For details on creating SLOs, configuring targets, and understanding measurement windows, see [Agent SLOs](/slos).
