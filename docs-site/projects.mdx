...
On first run, LangSight creates a **Default** project automatically. All dashboard pages scope to this project. Create additional projects via the sidebar → **New Project**.
...
```json
[
  { "id": "abc123def456...", "name": "Default", "slug": "default" },
  { "id": "xyz789...", "name": "Production", "slug": "production" }
]
```
